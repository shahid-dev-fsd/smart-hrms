...
const AwardPage = () => {
    ...
    const userData = [
        {no:'1',id:29431, name:'Emma Stone', des:'Web Designer', attend:'94', type:'Employee of the Month',  profile:'Cash' },
        {no:'2',id:48592, name:'Daniell Waish', des:'QA Tester', attend:'53', type:'Early Bird Award',  profile:'Trophy'},
        {no:'3',id:39104, name:'Jason Hack',  des:'Data Scientist', attend:'73', type:'Best Attendance',  profile:'Cash' },
        {no:'4',id:11945, name:'Ted Bobby',  des:'Ux/UI Designer', attend:'38', type:'Most Creative',  profile:'Trophy' },
        {no:'5',id:11943, name:'Amina Hira',  des:'Backend Developer', attend:'65', type:'Stand Out Performance',  profile:'Cash'},
        {no:'6',id:99032, name:'Nathan Percy',  des:'Frontend Developer', attend:'52', type:'Work Anniversary',  profile:'Trophy'},
        {no:'7',id:28149, name:'Ashley Dan',   des:'Data Scientist', attend:'32', type:'Character Award',  profile:'Cash' },
        {no:'8',id:38149, name:'Dustin Zack',  des:'Full Stack Developer', attend:'58', type:'Best Team Player',  profile:'Trophy' },
        {no:'9',id:88563, name:'Nathalie Soa',  des:'QA Tester', attend:'72', type:'Most improved',  profile:'Cash'},
        {no:'10',id:99034, name:'Vanessa Gad',  des:'Data Analyst', attend:'50', type:'Sales Award',  profile:'Trophy'},
        ...
        <div className='flex flex-col'>
            ...
            <Box className="w-full ml-2 md:ml-0 pt-4 rounded-lg mb-4" sx={{ backgroundColor: 'background.view', }}>
                <div className='flex items-center mb-5 md:w-full'>
                        <p className='text-[8px] md:text-[12px]  pl-2 md:pl-5'>Rows per page: 10 <FontAwesomeIcon icon={faCaretDown} className='text-zinc-500 text-sm md:text-[12px] text-center ml-2 mr-2 text-center'/></p>
                </div>
