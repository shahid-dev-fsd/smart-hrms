...
import { Box, Button, Card, CardActions, CardContent, Chip, DialogActions, Grid, IconButton, MenuItem, Modal, Pagination, Skeleton, TextField, Tooltip, Typography } from '@mui/material';
            ...
            <Grid container spacing={2} my={1.5}>
                {jobApplications ? (
                    jobApplications?.map(jobApplication => {
                        const appliedDate = new Date(jobApplication.createdAt).toLocaleDateString(
                            'en-IN'
                        );
                            ...
                            <Grid item xl={3} md={4} sm={6} xs={12}>
                                <Card
                                    ...
                                    <Box
                                        ...
                                        <Box>
                                            <Link
                                                to={`/jobApplicationDetail/${jobApplication._id}`}>
                                                <Button
                                                    size='small'
                                                    variant='contained'
                                                    sx={{
