                ...
                {letter ? (
                    <>
                        <Stack
                            ...
                            <CdnImage
                                src='catch/logo/2023/catch-text.png'
                                width='100'
                                height='40'
                            />
                            <Box
                                ...
                                <Box>
                                    ...
                                    <Typography variant='subtitle1' fontWeight={500}>
                                        ...
                                        <Typography
                                            color='primary.main'
                                            component={NavLink}
                                            to={`https://careers.catch.com/${letter.jobId}`}>
                                            Read More
                                        </Typography>
                                    </Typography>
                                </Box>
                        ...
                        <Grid container justifyContent='space-around' alignItems='center' pt={8}>
                            <Grid item lg={5} xs={12}>
                                ...
                                <Typography variant='subtitle1' fontWeight={500}>
                                    ...
                                    the impossible with us and unlock your potential at Catch.
                                </Typography>
                            </Grid>
                            <Grid
                                item
                        ...
                        <Box
                            ...
                            <Typography variant='subtitle1' mb={2}>
                                your employment with Catch is at-will and either party can terminate
                                ...
                                the entire agreement between you and Catch.
                            </Typography>
                            <Typography variant='subtitle1'>
