...
const AuthorizationProvider = ({ children }) => {
  ...
  return (
    <authorizeContext.Provider value={{ authorize, setUser, user, setContent, currentOrganization }}>
      <SocketProvider>
      {content}
      </SocketProvider>
...
const useOrganization = () => useContext(authorizeContext)?.currentOrganization;
...
export { useAuthorize, useUser, useSetUser, useSetContent, useEmployees, useOrganization };
