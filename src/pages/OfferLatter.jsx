...
const Letter = () => {
    ...
    const goToJobDescription  = (jobId)=>{
        ...
        let  jobDecPage  = '/career/job/'+jobId
        window.open(jobDecPage, '_blank', 'noopener,noreferrer')
                ...
                <Container sx={{ maxWidth: '1216px', mx: 'auto', p: 2 }}>
                    ...
                    <Grid container justifyContent='space-around' alignItems='center' pt={8}>
                        <Grid  item lg={5} xs={12}>
                            ...
                            <Typography variant='subtitle1' fontWeight={500}>
                                ...
                                impossible with us and unlock your potential at {organization.name}.
                            </Typography>
                        </Grid>
                        <Grid
                                item
                    ...
                    <Box
                        ...
                        <Typography variant='subtitle1' mb={2}>
                            your employment with {organization.name} is at-will and either party can terminate the
                            ...
                            agreement between you and {organization.name}.
                        </Typography>
                        <Typography variant='subtitle1'>
