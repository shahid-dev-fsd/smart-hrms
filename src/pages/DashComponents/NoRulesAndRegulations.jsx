...
const NoRulesAndRegulations = ({ eventData }) => {
    ...
    <Box className="rounded-lg" sx={{ padding: 2, backgroundColor: "Background.view", borderRadius: '12px' }}>
      ...
      >
        ...
        <Typography variant="h6" sx={{ marginBottom: 1, fontFamily: "sans-serif", fontSize: "13px" }}>
          No Current Rules And Regulations
        </Typography>
        <Typography variant="body2" sx={{ color: grey[400], marginBottom: 1, fontSize: "10px" }}>
          You do not have any current Rules And Regulations available.<br/> Click the button below to add new Rules And Regulations.
        </Typography>
...
export default NoRulesAndRegulations;
