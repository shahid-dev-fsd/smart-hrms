...
export default function AllTasks() {
  ...
  const fetchData = async (pageIndex, pageSize, sorting) => {
    ...
    const response = await axios.get(`/hr/task`, {
      params: {
        page: pageIndex + 1,
        limit: pageSize,
        // sort: sortField,
    ...
    setTotalRows(response.data.result.totalPages);
  };
  useEffect(() => {
    fetchData(pagination.pageIndex, pagination.pageSize, sorting);
  }, [pagination.pageIndex, pagination.pageSize, sorting]);
  const columns = [
    { header: "Task Name", accessorKey: "name", enableSorting: false },
    {
    ...
    { header: "Start Date", accessorKey: "startDate", enableSorting: false },
    { header: "End Date", accessorKey: "endDate", enableSorting: false },
    {
      accessorKey: "actions",
      header: "Actions",
      enableSorting: false,
        ...
        <FormGroup>
          <FormControlLabel
            control={
              <Checkbox
                checked={
                  row.original.statusId.name == "completed" ? true : false
                }
                onChange={() => {}}
              />
            }
