...
export default function AddressProof() {
  ...
  const fields = [
    ...
    {
      field: "isThereAnyChangeInPresentAddress",
    ...
    },
    {
      ...
      label: "Enter The Reason For Request",
    },
    {
  ...
  const addRecordModalFields = [
    ...
    },
    {
      ...
      options: ["Current Experience 1", "Current Experience 2"],
      defaultValue: "",
    },
    {
      type: "select",
      name: "isThereAnyChangeInPresentAddress",
      label: "Is There Any Change In Present Address",
      options: [
        { label: "Yes", value: "yes" },
        { label: "No", value: "no" },
  ...
  const editRecordModalFields = [
    {
      ...
      label: "EmployeeID",
      options: ["EmployeeID 1", "EmployeeID 2"],
      defaultValue: "EmployeeID 1", // Default value for editing
    },
    {
      type: "datePicker",
      label: "Date Of Request",
      name: "dateOfRequest",
      defaultValue: dayjs("2023-10-01"), // Default value for editing
    },
    {
      type: "datePicker",
      label: "Date Of Joining",
    ...
    },
    {
      ...
      label: "Designation",
      options: ["Designation 1", "Designation 2"],
      defaultValue: "Designation 1", // Default value for editing
      disabled: true, // Disabled field
    },
    {
      type: "autocomplete",
      ...
      label: "Department",
      options: ["Department 1", "Department 2"],
      defaultValue: "Department 1", // Default value for editing
      disabled: true, // Disabled field
    },
    {
      type: "autocomplete",
      ...
      defaultValue: "Reason 1", // Default value for editing
    },
  ];
  ...
  const viewRecordModalFields = [
    {
      ...
      label: "EmployeeID",
      options: ["EmployeeID 1", "EmployeeID 2"],
      defaultValue: "EmployeeID 1", // Default value for viewing
      disabled: true, // Disabled field
    },
    {
      type: "datePicker",
      label: "Date Of Request",
      name: "dateOfRequest",
      defaultValue: dayjs("2023-10-01"), // Default value for viewing
      disabled: true, // Disabled field
    },
    {
      type: "datePicker",
    ...
    },
    {
      ...
      label: "Designation",
      options: ["Designation 1", "Designation 2"],
      defaultValue: "Designation 1", // Default value for viewing
      disabled: true, // Disabled field
    },
    {
      type: "autocomplete",
      ...
      label: "Department",
      options: ["Department 1", "Department 2"],
      defaultValue: "Department 1", // Default value for viewing
      disabled: true, // Disabled field
    },
    {
      type: "autocomplete",
      ...
      label: "Reason For Request",
      options: ["Reason 1", "Reason 2"],
      defaultValue: "Reason 1", // Default value for viewing
      disabled: true, // Disabled field
    },
  ];
  return (
